...
$string['createformsoffline'] = 'Create forms offline';
$string['createformsoffline_help'] = 'Queue the form creation process to run in the background. You will receive an email notification when the forms are ready for download.';
...
$string['formsalreadyexist'] = 'Forms already exist for this offline quiz.';
...
$string['offlineformscreated'] = 'Offline forms for "{$a}" have been created successfully';
$string['offlineformscreatedsubject'] = 'Offline forms ready for download';
$string['offlineformscompletedmessage'] = 'Your offline quiz forms have been created and are now available for download.';
$string['offlineformserror'] = 'Error creating offline forms for "{$a}"';
$string['offlineformserrormessage'] = 'There was an error creating your offline forms: {$a}';
$string['offlineformserrorsubject'] = 'Error creating offline forms';
$string['offlineformslink'] = 'You can download the forms here: {$a}';
$string['offlineformsqueued'] = 'Form creation has been queued. You will receive an email notification when the forms are ready.';
